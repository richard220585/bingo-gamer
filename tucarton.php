...
<head>
    ...
    <style>
        ...
        body.solo-modal > *:not(#cartonModal) { display: none !important; }

        /* Responsive adjustments */
        @media (max-width: 600px) {
            .celda { padding: 8px; font-size: 12px; }
            #modalContent {
                width: 95%;
                padding-left: 80px;
            }
...
<body>
            ...
            <div class="grupo-fecha" onclick="toggleCartones('cartones-<?= md5($fecha) ?>')">
                ...
                <div id="cartones-<?= md5($fecha) ?>" class="carton-grid hidden">
                    <?php foreach ($cartones as $carton) : ?>
                        <?php if (isset($cartones_data[(string)$carton])) : ?>
    ...
    <div id="cartonModal">
        <div id="modalContent">
            ...
            <img src="imagenes/miportada.png" alt="Mi Portada" style="position: absolute; top: 10px; left: 10px; width: 100px; height: auto; z-index: 10;">
    ...
    <script>
        ...
        function mostrarCarton(numero) {
            ...
            document.body.classList.add('solo-modal');
        ...
        function cerrarModal() {
            document.body.classList.remove('solo-modal');
